 ...
 * generated in the ru.kogut.product package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetAllProductsRequest_QNAME = new QName("http://kogut.ru/ws/product", "getAllProductsRequest");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.kogut.product
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://kogut.ru/ws/product", name = "getAllProductsRequest")
